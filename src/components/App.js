    ...
    <div className="noselect">
      ...
      <Switch>
        ...
        <Route exact path="/search">
          <SearchPage sideBar={sideBar} setSideBar={setSideBar} />
        </Route>
        ...
        <Route exact path="/login">
          {isLoggedIn ? (
            ...
            <Login loginStatus={isLoggedIn} updateLoginStatus={setIsLoggedIn} />
          )}
        </Route>
        ...
        <Route exact path="/addspot">
          {!isLoggedIn ? <Redirect to="/login" /> : <AddPost />}
        </Route>

        <Route exact path="/bookmarks">
          {!isLoggedIn ? <Redirect to="/login" /> : <Bookmark />}
        </Route>

        <Route exact path="/bookmarkupdate">
          {!isLoggedIn ? <Redirect to="/login" /> : <BookmarkUpdate />}
        </Route>
      </Switch>
    </div>
  );
